					...
					<fieldset>
						<div class="rc_layout">
							<div class="rc_layout__xs__12 rc_layout__md__6 rc_layout__lg__6">
								...
								<input type="text" name="first_name" placeholder="First Name" class="rc_form__input" data-message="Please enter your first name" required>
							</div>
							<div class="rc_layout__xs__12 rc_layout__md__6 rc_layout__lg__6">
								<label for="" class="rc_form__label">Last Name</label>
								<input type="text" name="last_name" placeholder="Active" class="rc_form__input" data-message="Please enter your last name" required>
							</div>
						</div>
						<div class="rc_layout">
							<div class="rc_layout__xs__12 rc_layout__md__6 rc_layout__lg__6">
								<label for="" class="rc_form__label">Email Address</label>
								<input type="email" name="email" placeholder="Error field" class="rc_form__input" data-message="Please enter your email address" data-regex="/.+@.+\..+/i" required>
							</div>
							<div class="rc_layout__xs__12 rc_layout__md__6 rc_layout__lg__6">
								<label for="" class="rc_form__label">Website Address</label>
								<input type="text" name="website" placeholder="http://" class="rc_form__input" data-message="Please enter the url of your website" required>
							</div>
						</div>
						<div class="rc_layout">
							<div class="rc_layout__sm__12">
								<label for="" class="rc_form__label">PayPal Email Address</label>
								<input type="text" name="paypal_address" placeholder="Which email address should we send your rewards to?" class="rc_form__input" data-message="Please enter your PayPal Email Address" data-regex="/.+@.+\..+/i" required>
							</div>
						</div>
						<div class="rc_layout">
							<div class="rc_layout__sm__12">
								<label for="" class="rc_form__label">Include Shopify URL that currently has ReCharge installed:</label>
								<input type="text" name="storeUrl" placeholder="Store URL" class="rc_form__input" data-message="Please enter the store URL where you have ReCharge installed" required>
							</div>
						</div>
						<label>Does your client already offer subscriptions?</label>
						<div class="rc_form_radio_group inputs-inline">
			...
			<div class="rc_layout">
				<div class="firstblock rc_layout__xs__12 rc_layout__sm__12 rc_layout__md__6 rc_layout__lg__6">
					<div class="sg_checkbox_status">
						...
						<input type="checkbox" id="sg_checkbox3" class="rc_form__checkbox" disabled>
						<label for="sg_checkbox3" class="rc_form__label"></label>
						<input type="checkbox" id="sg_checkbox4" class="rc_form__checkbox rc_error">
						<label for="sg_checkbox4" class="rc_form__label"></label>
					</div>
					<div class="sg_radio_status">
						<input type="radio" id="sg_radio1" class="rc_form__radio" checked>
						...
						<input type="radio" id="sg_radio3" class="rc_form__radio" disabled>
						<label for="sg_radio3" class="rc_form__label"></label>
						<input type="radio" id="sg_radio4" class="rc_form__radio rc_error">
