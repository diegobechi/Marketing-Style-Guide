	...
	<div class="rc_sg_section logo-usage_section">
		...
		<div class="rc_sg_full_logo">
			<div class="rc_sg_full_logo_container">
				<div class="rc_sg_full_logo_container_item bg_white"><img class="rc_logo rc_logo_main" src="../assets/images/logos/rc_logo.svg"></div>
				<label class="rc_caption">ON LIGHT</label>
			</div>
			<div class="rc_sg_full_logo_container">
				<div class="rc_sg_full_logo_container_item bg_rc_blue"><img class="rc_logo rc_logo_white" src="../assets/images/logos/rc_logo_white.svg"></div>
	...
	<div class="rc_sg_section logo-usage_section">
		...
		<div class="rc_sg_icon_logo">
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_white"><img src="../assets/images/logos/rc_icon_blue.svg"></div>
				<label class="rc_caption">ON LIGHT</label>
			</div>
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_rc_blue"><img src="../assets/images/logos/rc_icon_white.svg"></div>
				<label class="rc_caption">ON DARK</label>
			</div>
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_white"><img src="../assets/images/logos/rc_icon_black.svg"></div>
				<label class="rc_caption">BLACK</label>
			</div>
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_white"><img src="../assets/images/logos/rc_icon_grey.svg"></div>
