	...
	<div class="rc_sg_section logo-usage_section">
		...
		<div class="rc_sg_full_logo">
			<div class="rc_sg_full_logo_container">
				<div class="rc_sg_full_logo_container_item bg_rc_white"><img class="rc_logo rc_logo_main" src="../assets/images/logos/rc_logo.svg"></div>
	...
	<div class="rc_sg_section logo-usage_section">
		...
		<div class="rc_sg_icon_logo">
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_rc_white"><img src="/assets/images/logos/rc_icon_blue.svg"></div>
				<label class="rc_caption">ON LIGHT</label>
			</div>
			<div class="rc_sg_icon_logo_container">
			...
			<div class="rc_sg_icon_logo_container">
				<div class="rc_sg_icon_logo_container_item bg_rc_white"><img src="/assets/images/logos/rc_icon_black.svg"></div>
