...
<div>
	...
	<div class="rc_sg_section colors_section">
		...
		<div class="colors_pallete">
			...
			<div class="rc_sg_color-container"><div class="circle bg_blue_dark"><label for="">Dark blue</label></div><p class="rc_caption">#004E82</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_magenta"><label for="">Magenta</label></div><p class="rc_caption">#C00399</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_magenta_hover"><label for="">Hover Magenta</label></div><p class="rc_caption">#AC0289</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_black"><label for="">Black</label></div><p class="rc_caption">#000000</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_grey_dark"><label for="">Dark grey</label></div><p class="rc_caption">#424242</p></div>
			...
			<div class="rc_sg_color-container"><div class="circle bg_grey_medium"><label for="">Medium grey</label></div><p class="rc_caption">#8E8F8E</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_grey_light"><label for="">Light grey</label></div><p class="rc_caption">#CCCCCC</p></div>
			<div class="rc_sg_color-container"><div class="circle bg_grey_silver"><label for="">Silver</label></div><p class="rc_caption">#EEEEEE</p></div>
	...
	<div class="rc_sg_section colors_section">
		...
		<div class="colors_pallete">
			...
			<div class="rc_sg_color-container"><div class="circle bg_pink"><label for="">Pink</label></div><p class="rc_caption">#D06EAB</p></div>
		</div>
	</div>
</div>
