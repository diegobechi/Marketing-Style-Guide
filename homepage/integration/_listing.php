...
<?php if (strpos($page_active, "cart-abandonment") != true) { ?>
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/cart-abandonment"><img src="/assets/images/integrations/cart-abandonment_logo.png" alt="Cart Abandonment logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Cart Abandonment</strong>
...
<?php if (strpos($page_active, "checkout-funnel") != true) { ?>
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/checkout-funnel"><img src="/assets/images/integrations/checkout-funnel_logo.png" alt="Smile.io logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Checkout Funnel</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "google-analytics") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/google-analytics"><img src="/assets/images/integrations/google-analytics_logo.png" alt="Google Analytics logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Google Analytics</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "gorgias") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/gorgias"><img src="/assets/images/integrations/gorgias_logo-min.png" alt="Gorgias logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Gorgias</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "klaviyo") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/klaviyo"><img src="/assets/images/integrations/klaviyo_logo.png" alt="Klaviyo logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Klaviyo</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "leaddyno") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/leaddyno"><img src="/assets/images/integrations/leaddyno_logo.png" alt="LeadDyno logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">LeadDyno</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "littledata") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/littledata"><img src="/assets/images/integrations/littledata_logo.png" alt="Littledata logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Littledata</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "mailchimp") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/mailchimp"><img src="/assets/images/integrations/mailchimp_logo.png" alt="MailChimp logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">MailChimp</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "one-click-upsell") != true) { ?>
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/one-click-upsell"><img src="/assets/images/integrations/one-click-upsell_logo.png" alt="One Click Upsell logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">One Click Upsell</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "referralcandy") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/referralcandy"><img src="/assets/images/integrations/referralcandy_logo.png" alt="ReferralCandy logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">ReferralCandy</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "refersion") != true) { ?>
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/refersion"><img src="/assets/images/integrations/refersion_logo.png" alt="Refersion logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Refersion</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "Smile.io") != true) { ?>
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/smile-io"><img src="/assets/images/integrations/smile-io_logo.png" alt="Smile.io logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Smile.io</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<?php if (strpos($page_active, "ultimate-upsell") != true) { ?> 
	<div class="integrations__directory__item">
		<div class="integrations__directory__item__media">
			<a href="/integration/ultimate-upsell"><img src="/assets/images/integrations/ultimate-upsell_logo.png" alt="Ultimate Upsell logo" class="integrations__directory__item__logo"></a>
			<strong class="integrations__directory__item__title">Ultimate Upsell</strong>
		</div><!-- .integrations__directory__item__media -->
		<div class="integrations__directory__item__info">
...
<script>
	function setMinHeight() {
		...
		$('.integrations__directory__item').each(function() {
		...
		$('.integrations__directory__item').animate({'height': integrationCardHeight + 20}, 200);
	}
	$(function() {
		setMinHeight()
